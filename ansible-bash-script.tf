...
echo "${tls_private_key.team_1_key.private_key_pem}" >> /home/ec2-user/.ssh/id_rsa
...
sudo NEW_RELIC_API_KEY="NRAK-AB17Y029WKASJ95VKYHL50DSGMM" \
NEW_RELIC_ACCOUNT_ID="8051063" \
NEW_RELIC_REGION="EU" \
